...
| a2_funding_extreme_reversal_v1 | 极端funding拥挤→反转 | **FAILED（2026-06-11，独立Alpha第6）** | 方向整体相反：该周期极端拥挤=延续非反转（与TSMOM动量证据互洽）；外部grounding为交易所博客级 | 反转版不复活；"延续"为同样本事后发现（污染），仅可在全新数据上另案预登记 |
